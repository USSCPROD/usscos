...
<p style="font-size:.78rem;color:#9ca3af;margin:1rem 0 2rem">
    Rep attribution came from a QuickBooks Sales&nbsp;by&nbsp;Rep export covering
    <strong>2026 only</strong>, so earlier years show as "never imported". Employees, the
    owner, and placeholder entries are deliberately excluded from the rep table — Larry
    Fitzpatrick alone accounts for 1,945 invoices and would otherwise dominate it.
</p>
