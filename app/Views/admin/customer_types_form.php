...
<div class="page-header">
    <div class="page-header__left">
        <a href="/admin/customer-types" class="back-link">
            <svg width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19l-7-7 7-7"/></svg>
            Customer Types
        </a>
        <h1 class="page-title"><?= $editing ? 'Edit Customer Type' : 'Add Customer Type' ?></h1>
    </div>
</div>
...
<div class="card" style="max-width:520px;padding:1.5rem">
    <form method="post" action="<?= $editing ? '/admin/customer-types/' . (int)$item['id'] . '/edit' : '/admin/customer-types' ?>">
        ...
        <div style="display:flex;gap:.75rem">
            ...
            <a href="/admin/customer-types" class="btn btn--secondary">Cancel</a>
        </div>
    </form>
</div>
